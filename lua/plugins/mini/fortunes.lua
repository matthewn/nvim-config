-- Programming quotes slurped verbatim from vim-startify
-- (startify#fortune#predefined_quotes). Each entry is a list of display lines:
-- the quote, an optional blank separator line, then an attribution.
...
-- Return a random quote (a list of lines).
function M.random()
